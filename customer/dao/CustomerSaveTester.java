...
public class CustomerSaveTester {
	...
	public static void main(String[] args) {
		...
		CustomerDTO dto2 = new CustomerDTO("Rakshita", "Ananthapur", "Delhi", "Venugopal nagar, Ananthapur", false,
				123456782, Education.BE);
		CustomerDTO dto3 = new CustomerDTO("Sahana", "Bangalore", "Vijayawada", "RK nagar, Tumkur", false, 123456783,
				Education.BE);
		CustomerDTO dto4 = new CustomerDTO("Shantanu", "Neyveli", "Chennai", "Arch Gate, Neyveli", true, 123456784,
				Education.ME);
		CustomerDTO dto5 = new CustomerDTO("Dhanya", "Salem", "Goa", "Gorimedu, Salem", false, 123456785, Education.MBA);
